...
public class Zombie_Atack {
	 ...
	 * day, every city will lose half of its population. write a program to loop
	 * though each city population and make it lose half of its population until all
	 * cities have no humans left. Make updates to each element in the array And
	 * print the array like below for each day:
	 * 
